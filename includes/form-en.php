...
<link href="https://fonts.googleapis.com/css2?family=Lato&family=Montserrat&family=Roboto&display=swap" rel="stylesheet">
  <form method="POST" action="https://momcleaning.activehosted.com/proc.php" id="_form_10_" class="_form _form_10 _inline-form  _dark" novalidate>
    ...
    <input type="hidden" name="or" value="7f617728889a7e9ff5e787130a1fbd75" />
    <div class="_form-content">
      ...
      <div class="_form_element _field2 _full_width " >
        ...
        <div class="_field-wrapper">
          <textarea id="field[2]" name="field[2]" placeholder="Do you wish to leave a message to our team?"  ></textarea>
        </div>
      </div>
...
window.cfields = {"10":"type_of_services","2":"message"};
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      fetch('https://momcleaning.vonigo.com/api/v1/security/login/?appVersion=1&company=Vonigo&password=d85e6d9684738b1db030600c525da86c&userName=laurent.olivier').then(function (response) {
        ...
        var selectDrop = document.getElementById('field[10]').value;
